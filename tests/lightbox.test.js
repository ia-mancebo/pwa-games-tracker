 ...
 * Suite migrada del módulo de la vista (src/views/game.js) a la primitiva
 * (src/ui/lightbox.js, ADR-0006): el camino de clic desde la Ficha sigue
 * siendo el cableado de la vista.
 */
